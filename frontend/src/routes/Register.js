                ...
                <section className="card">
                    <div className="search--box">
                        ...
                        <form onSubmit={this.handleForm}>
                            <label><input onChange={(event) => this.handleUserInput(event)} 
                            name="username" type="text" ref={(ref) => this.username = ref} 
                            placeholder="Username" required /></label>
                            <label><input onChange={(event) => this.handleUserInput(event)} 
                            name="email" type="text" ref={(ref) => this.email = ref} 
                            placeholder="email" /></label>
                            <label><input onChange={(event) => this.handleUserInput(event)} 
                            name="password" type="password" ref={(ref) => this.password = ref} 
                            placeholder="Password" required /></label>
                            <label><input onChange={(event) => this.handleUserInput(event)} 
                            name="fName" type="text" ref={(ref) => this.fName = ref} 
                            placeholder="First Name" /></label>
                            <label><input onChange={(event) => this.handleUserInput(event)} 
                            name="lName" type="text" ref={(ref) => this.lName = ref} 
                            placeholder="Last Name" /></label>
                            <label><input onChange={(event) => this.handleUserInput(event)} 
                            name="mobile" type="text" ref={(ref) => this.mobile = ref} 
                            placeholder="mobile" /></label>
                            <label><input onChange={(event) => this.handleUserInput(event)} 
                            name="title" type="text" ref={(ref) => this.title = ref} 
